...
| 5   | Banco de imagens institucional para novas unidades/seções e CTAs          | CENPRE         | Home e as 9 subpáginas já têm fotos reais nos heros (ver [IMAGENS.md](./IMAGENS.md)), mas o estoque de fotos avulsas está esgotado — CTAs de fechamento estão sem foto (usuário rejeitou os cutouts reaproveitados) e cards da Biblioteca de Conteúdos seguem em placeholder; precisa de fotos novas **com fundo completo** (não recorte) |
