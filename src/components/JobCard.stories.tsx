...
export const Padrao: Story = {
  render: (args) => <div style={{ maxWidth: 380 }}><JobCard {...args} /></div>,
};

export const FonteParceira: Story = {
  args: { source: "NUBE", area: "Saúde", title: "Estágio em Nutrição", company: "Hospital Regional", salary: "R$ 900,00 + Benefícios" },
  render: (args) => <div style={{ maxWidth: 380 }}><JobCard {...args} /></div>,
};
...
export const Grid: Story = {
  render: () => (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, maxWidth: 1100 }}>
      <JobCard area="Marketing" source="CENPRE" modality="Estágio" title="Assistente de Marketing" company="Tech Solutions" location="Campos dos Goytacazes, RJ" salary="R$ 1.000,00 + Benefícios" />
