...
function Group({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="flex flex-col gap-6 border-t border-ash-200 py-12">
      <h2 className="text-sm font-semibold uppercase tracking-[0.16em] text-magenta-700">
        {title}
      </h2>
      {children}
    </section>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <PageHero
        ...
        actions={
          <>
            <Button variant="secondary" className="bg-white text-magenta-800">
              Ver no Figma
            </Button>
      ...
      <main className="mx-auto max-w-content px-6 md:px-gutter">
        <Group title="Botões">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button size="lg" rightIcon={<Icons.ArrowRightIcon size={18} />}>
              Large
            </Button>
          </div>
        </Group>
        ...
        <Group title="Formulário">
          <div className="grid max-w-xl gap-4">
            ...
            <Input
              ...
              hint="Usaremos para retornar o contato."
            />
        ...
        <Group title="Cards de destaque (módulos / números)">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCard
              ...
              description="Rede de instituições que oferecem estágio e emprego."
            />
            <FeatureCard
              icon={<Icons.CheckIcon />}
              title="Suporte em todas as etapas"
              description="Do cadastro à efetivação, com orientação e gestão de documentos."
            />
          </div>
        </Group>
        ...
        <Group title="Documentos por etapa">
          <div className="grid gap-5 md:grid-cols-3">
            <DocCard
              label="Início"
              icon={<Icons.BuildingIcon size={20} />}
              items={[
                "Manual de estágio",
                "Emissão do TCE",
            ...
            <DocCard
              label="Durante"
              icon={<Icons.BriefcaseIcon size={20} />}
              items={["Termo aditivo", "Relatório de acompanhamento"]}
            />
            <DocCard
              label="Encerramento"
              icon={<Icons.CheckIcon size={20} />}
          ...
          <TabsPills
            items={[
              ...
              },
              {
                ...
                content: (
                  <p className="text-charcoal-400">
                    Atividade opcional que complementa a formação.
                  </p>
                ),
              },
            ]}
